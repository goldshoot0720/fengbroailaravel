...
<script src="assets/js/main.js?v=20260520bankbatch"></script>
...
<script>
    (function () {
        ...
        const firstNotice = document.querySelector('.sleep-warning, .tube-home-notice, .finance-home-notice, .content-header');
        if (firstNotice && firstNotice.parentNode) {
            firstNotice.parentNode.insertBefore(countdown, firstNotice);
        } else if (content) {
            content.prepend(countdown);
        } else {
