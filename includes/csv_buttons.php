<?php if (isset($csvTable)):
    ...
    $zipGenericTables = ['subscription', 'food', 'commonaccount', 'bank', 'routine', 'trialpurchase', 'reinstall', 'quota', 'shoppinglist'];
    ...
    <script>
        (function () {
            ...
            window['importCSV_' + TABLE] = function (input) {
                ...
                const useChunked = ['food', 'subscription', 'bank', 'commonaccount', 'trialpurchase', 'reinstall', 'quota', 'shoppinglist'].indexOf(TABLE) !== -1
                    || file.size > 200 * 1024;
