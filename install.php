...
try {
    ...
    $upgrades = [
        ...
        // 讀取熱路徑索引（列表排序、重複資料查詢）；已存在會被下面的 try/catch 略過
        "ALTER TABLE subscription ADD INDEX `idx_subscription_deleted_next` (`deleted_at`, `nextdate`)",
        "ALTER TABLE subscription ADD INDEX `idx_subscription_name` (`name`)",
        "ALTER TABLE subscription ADD INDEX `idx_subscription_account` (`account`)",
        "ALTER TABLE food ADD INDEX `idx_food_todate` (`todate`, `created_at`)",
        "ALTER TABLE food ADD INDEX `idx_food_name_shop` (`name`, `shop`)",
        "ALTER TABLE article ADD INDEX `idx_article_deleted_created` (`deleted_at`, `created_at`)",
        "ALTER TABLE article ADD INDEX `idx_article_title` (`title`)",
        "ALTER TABLE image ADD INDEX `idx_image_created` (`created_at`)",
        "ALTER TABLE image ADD INDEX `idx_image_hash` (`hash`(191))",
        "ALTER TABLE image ADD INDEX `idx_image_name` (`name`)",
        "ALTER TABLE music ADD INDEX `idx_music_created` (`created_at`)",
        "ALTER TABLE music ADD INDEX `idx_music_hash` (`hash`(191))",
        "ALTER TABLE music ADD INDEX `idx_music_name` (`name`)",
        "ALTER TABLE podcast ADD INDEX `idx_podcast_created` (`created_at`)",
        "ALTER TABLE podcast ADD INDEX `idx_podcast_hash` (`hash`(191))",
        "ALTER TABLE podcast ADD INDEX `idx_podcast_name` (`name`)",
        "ALTER TABLE video ADD INDEX `idx_video_created` (`created_at`)",
        "ALTER TABLE video ADD INDEX `idx_video_hash` (`hash`(191))",
        "ALTER TABLE video ADD INDEX `idx_video_name` (`name`)",
        ...
        "ALTER TABLE commonaccount ADD INDEX `idx_commonaccount_name` (`name`)",
        "ALTER TABLE trialpurchase ADD INDEX `idx_trialpurchase_name_account` (`name`, `account`(100))",
